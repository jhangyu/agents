...
Production-ready agentic-workflow building blocks: **84 plugins** (82 local + 2 external), **206 agents**, **166 skills**, **113 commands**. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, and Gemini CLI from a single Markdown source.
...
- **[docs/agents.md](docs/agents.md)** — agent reference (206 agents, model tiers)
...
166 skills under `plugins/*/skills/<n>/SKILL.md` — discoverable by every harness:
...
206 subagents under `plugins/*/agents/<name>.md`. Per-harness transpilation:
