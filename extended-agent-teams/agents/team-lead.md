...
At the end of each major phase, broadcast to `team-doc-updater` with:
- A summary of what changed (files modified, interfaces defined, tasks completed)
- Which docs need updating (README, architecture docs, API docs, changelogs)
- Do NOT wait for acknowledgment — fire and continue
...
- Triggers team-doc-updater at each milestone to offload documentation work
