...
Use the Task tool with subagent_type="extended-agent-teams:legacy-modernizer":

```
Task:
  subagent_type: "extended-agent-teams:legacy-modernizer"
...
Use the Task tool with subagent_type="extended-agent-teams:architect-reviewer":

```
Task:
  subagent_type: "extended-agent-teams:architect-reviewer"
