...
description: Implements components within file ownership boundaries, coordinating with parallel implementers at integration points.
...
- Signals team-test-runner after each implementation unit
